                ...
                <div className="institute-list">
                        ...
                        <div className="row">
                                ...
                                <div className="col-sm-4">
                                        <MDBBtn btn color='warning' onClick={ addAcademy }>Add Academy</MDBBtn>
                                </div>
                        </div>
                        <div className="row">
                                        ...
                                        <div className="institute-preview col-sm-4" key={ institute.instituteId }>
                                                ...
                                                <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
                                                        ...
                                                        <MDBCardBody>
                                                                ...
                                                                <div className="row">
                                                                <MDBBtn btn color='warning' onClick={()=>editInstitute(institute)}>Edit</MDBBtn><pre>  </pre>
                                                                <MDBBtn btn color='light' onClick={()=>deleteInstitute(institute.instituteId)}>Delete</MDBBtn>
                                                                </div>
                                                        </MDBCardBody>
                                                </MDBCard>
                                        </div>
