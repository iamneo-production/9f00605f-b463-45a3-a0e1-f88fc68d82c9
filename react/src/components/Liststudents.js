                ...
                <div className="student-list">
                        ...
                        <div className="row">
                                ...
                                <div className="col-sm-4">
                                        <MDBBtn btn color='warning' onClick={ addStudent }>Add Student</MDBBtn>
                                </div>
                        </div>
                        <div className="row">
                                        ...
                                        <div className="student-preview col-sm-4" key={ student.studentId }>
                                                ...
                                                <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
                                                        ...
                                                        <MDBCardBody>
                                                                ...
                                                                <div className="row">
                                                                <MDBBtn btn color='warning' onClick={()=>editStudent(student)}>Edit</MDBBtn><pre>  </pre>
                                                                <MDBBtn btn color='light' onClick={()=>deleteStudent(student.studentId)}>Delete</MDBBtn>
                                                                </div>
                                                        </MDBCardBody>
                                                </MDBCard>
                                        </div>
